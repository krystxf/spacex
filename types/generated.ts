 ...
 * });
 */
export function useRoadsterQuery(baseOptions?: Apollo.QueryHookOptions<RoadsterQuery, RoadsterQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RoadsterQuery, RoadsterQueryVariables>(RoadsterDocument, options);
      }
export function useRoadsterLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RoadsterQuery, RoadsterQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RoadsterQuery, RoadsterQueryVariables>(RoadsterDocument, options);
        }
export type RoadsterQueryHookResult = ReturnType<typeof useRoadsterQuery>;
export type RoadsterLazyQueryHookResult = ReturnType<typeof useRoadsterLazyQuery>;
export type RoadsterQueryResult = Apollo.QueryResult<RoadsterQuery, RoadsterQueryVariables>;
...
export type LaunchQuery = {
  ...
  launch?:
    | {
        ...
        static_fire_date_utc?: any | null | undefined
        launch_site?:
          | {
              __typename?: 'LaunchSite'
...
export type LaunchNextQuery = {
  ...
  launchNext?:
    | {
        ...
        launch_date_unix?: any | null | undefined
        launch_date_utc?: any | null | undefined
        is_tentative?: boolean | null | undefined
...
export type MissionQuery = {
  ...
  mission?:
    | {
        ...
        manufacturers?: Array<string | null | undefined> | null | undefined
        ...
        payloads?:
          | Array<
              | {
                  ...
                  payload_mass_kg?: number | null | undefined
                  payload_type?: string | null | undefined
                }
              | null
              | undefined
            >
...
export type RoadsterQuery = {
  __typename?: 'Query'
  roadster?:
    | {
        __typename?: 'Roadster'
        period_days?: number | null | undefined
        speed_kph?: number | null | undefined
        earth_distance_km?: number | null | undefined
        mars_distance_km?: number | null | undefined
        details?: string | null | undefined
      }
    | null
    | undefined
 ...
 * });
 */
export function useLaunchNextQuery(
  baseOptions?: Apollo.QueryHookOptions<
    LaunchNextQuery,
    LaunchNextQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<LaunchNextQuery, LaunchNextQueryVariables>(
    LaunchNextDocument,
    options
  )
}
export function useLaunchNextLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<LaunchNextQuery, LaunchNextQueryVariables>(
    LaunchNextDocument,
    options
  )
}
export type LaunchNextQueryHookResult = ReturnType<typeof useLaunchNextQuery>
export type LaunchNextLazyQueryHookResult = ReturnType<
  typeof useLaunchNextLazyQuery
>
export type LaunchNextQueryResult = Apollo.QueryResult<
  LaunchNextQuery,
  LaunchNextQueryVariables
>
...
export function useLaunchesPastQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(
...
export function useLaunchesPastLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(
    LaunchesPastDocument,
    options
  )
}
...
>
export type LaunchesPastQueryResult = Apollo.QueryResult<
  LaunchesPastQuery,
  LaunchesPastQueryVariables
>
...
export function useMissionQuery(
  baseOptions: Apollo.QueryHookOptions<MissionQuery, MissionQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MissionQuery, MissionQueryVariables>(
    MissionDocument,
    options
  )
}
export function useMissionLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MissionQuery, MissionQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<MissionQuery, MissionQueryVariables>(
    MissionDocument,
    options
  )
}
...
export type MissionQueryResult = Apollo.QueryResult<
  MissionQuery,
  MissionQueryVariables
>
...
export function useMissionsQuery(
  baseOptions?: Apollo.QueryHookOptions<MissionsQuery, MissionsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MissionsQuery, MissionsQueryVariables>(
    MissionsDocument,
    options
  )
}
export function useMissionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MissionsQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<MissionsQuery, MissionsQueryVariables>(
    MissionsDocument,
    options
  )
}
export type MissionsQueryHookResult = ReturnType<typeof useMissionsQuery>
export type MissionsLazyQueryHookResult = ReturnType<
  typeof useMissionsLazyQuery
>
export type MissionsQueryResult = Apollo.QueryResult<
  MissionsQuery,
  MissionsQueryVariables
>
...
/**
 * __useRoadsterQuery__
 *
 * To run a query within a React component, call `useRoadsterQuery` and pass it any options that fit your needs.
 * When your component renders, `useRoadsterQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRoadsterQuery({
 *   variables: {
 *   },
 * });
 */
export function useRoadsterQuery(
  baseOptions?: Apollo.QueryHookOptions<RoadsterQuery, RoadsterQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<RoadsterQuery, RoadsterQueryVariables>(
    RoadsterDocument,
    options
  )
}
export function useRoadsterLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RoadsterQuery,
    RoadsterQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<RoadsterQuery, RoadsterQueryVariables>(
    RoadsterDocument,
    options
  )
}
export type RoadsterQueryHookResult = ReturnType<typeof useRoadsterQuery>
export type RoadsterLazyQueryHookResult = ReturnType<
  typeof useRoadsterLazyQuery
>
export type RoadsterQueryResult = Apollo.QueryResult<
  RoadsterQuery,
  RoadsterQueryVariables
>

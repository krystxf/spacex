                    ...
                    <div className="flex my-10" >
                        ...
                        >
                            ...
                            <div className="flex flex-col text-white font-medium divide-y divide-gray-500 w-full ">
                                ...
                                />           <Row
                                    title="mission name"
                                    value={launch?.mission_id?.length ?? 0 > 0 ? <Link href={`/missions/${launch.mission_id}`}>{JSON.stringify(launch.mission_id) ?? ""}</Link> : <span>{launch.mission_name ?? ""}</span>}
                                />
                                <Row
                                    title={
                                ...
                                <Row
                                    title="launch site"
                                    value={<abbr title={launch.launch_site?.site_name_long ?? undefined}>{launch.launch_site?.site_name ?? ""}</abbr>}
